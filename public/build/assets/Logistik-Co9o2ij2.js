...
<table class="items">
    ...
    <tr>
        ...
        <td style="text-align:right">${R(e.harga_bahan)}</td>
        <td style="text-align:right">${R(e.total_harga)}</td>
        <td>${e.keterangan||`-`}</td>
    </tr>
</table>
