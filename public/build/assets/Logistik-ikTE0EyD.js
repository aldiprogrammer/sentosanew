import{r as e}from"./chunk-CilyBKbf.js";import{a as t,l as n,n as r}from"./app-C6fmpWuu.js";import{t as i}from"./AdminLayout-Bp9UonrU.js";import{t as a}from"./KonfirmasiPassword-IMhGtXI_.js";var o=e(n(),1),s=r();function c({produksi:e,kurir:n,bahanpakaiList:r,itemstokbahans:c}){let[l,u]=(0,o.useState)(null),[d,f]=(0,o.useState)(``),[p,m]=(0,o.useState)(``),[h,g]=(0,o.useState)(``),[_,v]=(0,o.useState)(``),[y,b]=(0,o.useState)([]),[x,S]=(0,o.useState)(!1),[C,w]=(0,o.useState)(null),T=(0,o.useRef)(null),E=[`INDOOR`,`INDOOR 2`,`OUTDOOR`,`OUTDOOR 2`,`DISPLAY`,`OFFSET`,`DLL`],D=[`DLL`,`DYE`,`UV`,`OFFSET`,`TONER`,`ECOSOLVENT`,`SOLVENT`],O=(0,o.useMemo)(()=>{if(!l)return 0;let e=parseFloat(l.tinggi)||0,t=parseFloat(l.lebar)||0,n=parseFloat(l.qty)||1;return((l.satuan||``).toLowerCase()===`cm`?e/100*(t/100):e*t)*n},[l]),k=l?.bahan?.kategori_cetak===`DISPLAY`,A=(0,o.useMemo)(()=>l&&r?.filter(e=>Array.isArray(e.id_master_bahan)&&e.id_master_bahan.includes(l.bahan?.kode))||[],[l,r]),j=(0,o.useMemo)(()=>!_||!c?[]:c.filter(e=>e.kode_bahan_pakai===_&&parseFloat(e.luas)>0&&parseInt(e.qty)>0),[_,c]),M=parseInt(l?.qty)||1;(0,o.useMemo)(()=>y.map(e=>c?.find(t=>t.id===e)||null).filter(Boolean),[y,c]);let N=(0,o.useMemo)(()=>{let e=y.filter(Boolean);return j.filter(t=>!e.includes(t.id))},[j,y]),P=(0,o.useMemo)(()=>y.length===M?y.reduce((e,t)=>{let n=c?.find(e=>e.id===t);return e+(n?parseFloat(n.luas):0)},0)>=O:!1,[y,O,M,c]),F=e=>!p||p===e,I=(0,o.useMemo)(()=>{let t={};for(let n of E){if(!F(n))continue;let r=e.filter(e=>e.bahan?.kategori_cetak===n&&(!h||e.bahan?.jenis_bahan===h)),i={};for(let e of r){let t=e.bahan?.jenis_bahan||`Lainnya`;i[t]||(i[t]=[]),i[t].push(e)}t[n]=i}return t},[e,E,p,h]),L=e=>{u(e),f(``),v(e.kode_bahanpakai??``),b(Array(parseInt(e.qty)||1).fill(``)),T.current?.showModal()},R=()=>{u(null),T.current?.close()},z=e=>{let t=parseFloat(e);return isNaN(t)?`-`:`Rp `+t.toLocaleString(`id-ID`)},B=(e,t)=>{let n=new Date().toLocaleDateString(`id-ID`,{day:`2-digit`,month:`long`,year:`numeric`}),r=(e.customer?.nama||``).toUpperCase(),i=(t||``).toUpperCase();return`
<!DOCTYPE html>
<html>
...
<table class="items">
    ...
    <tr>
        ...
        <td style="text-align:right">${z(e.harga_bahan)}</td>
        <td style="text-align:right">${z(e.total_harga)}</td>
        <td>${e.keterangan||`-`}</td>
    </tr>
</table>
