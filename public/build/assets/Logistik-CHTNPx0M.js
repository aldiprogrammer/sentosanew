...
<div class="info">
    <table>
        ...
        <tr><td><strong>Tanggal Antar</strong></td><td>: ${e.tgl_kirim?new Date(e.tgl_kirim).toLocaleDateString(`id-ID`,{day:`2-digit`,month:`long`,year:`numeric`}):`-`}</td></tr>
...
<div class="signatures">
    <div class="sig-block">
        ...
        <div class="line">${n||`( _____________________ )`}</div>
    </div>
    <div class="sig-block">
