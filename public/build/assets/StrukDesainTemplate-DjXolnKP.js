...
`,i=({items:i,auth:a,paymentType:o})=>{let s=new Date,c=i.reduce((e,t)=>e+Number(t.total_harga||0),0);i.reduce((e,t)=>e+Number(t.qty||0),0);let l=i[0],u=l?.customer,d=l?.no_invoice||l?.no_antrian||`-`,f=i[0]?.cs?.username||a?.user?.username||a?.user?.name||`Admin`,p={lunas:`TUNAI`,utang:`UTANG`,transfer:`TRANSFER`,qris:`QRIS`}[o]||`TUNAI`,m=i.map((e,t)=>`
            <tr${t%2==1?` class="alt"`:``}>
