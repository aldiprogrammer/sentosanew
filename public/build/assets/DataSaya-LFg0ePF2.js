import{r as e}from"./chunk-CilyBKbf.js";import{a as t,i as n,l as r,n as i}from"./app-vxdSZJc_.js";import{t as a}from"./AdminLayout-M9KnCeQk.js";var o=e(r(),1),s=i();function c({produksi:e,tglAwal:r,tglAkhir:i}){let[c,l]=o.useState(``),[u,d]=o.useState(r||``),[f,p]=o.useState(i||``),[m,h]=o.useState([]),g=(0,o.useRef)(null),_=(0,o.useRef)(null),v=e.data.map(e=>e.id),y=v.length>0&&m.length===v.length,b=e=>{h(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},x=()=>{h(y?[]:[...v])},S=e.data.filter(e=>m.includes(e.id)),C=S.reduce((e,t)=>e+Number(t.total_harga||0),0),w=S.reduce((e,t)=>e+Number(t.qty||0),0),T=e=>{e.preventDefault(),h([]),t.get(`/produksi/data-saya`,{search:c,tgl_awal:u,tgl_akhir:f},{preserveState:!0,replace:!0})},E=e=>{if(e&&S.length>0){let e=A(S),t=_.current?.contentDocument||_.current?.contentWindow?.document;t&&(t.open(),t.write(e),t.close()),g.current?.showModal()}},D=e=>String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`),O=(e=new Date)=>new Intl.DateTimeFormat(`id-ID`,{day:`2-digit`,month:`short`,year:`numeric`}).format(e),k=(e=new Date)=>new Intl.DateTimeFormat(`id-ID`,{hour:`2-digit`,minute:`2-digit`,hour12:!1}).format(e),A=e=>{let t=new Date,n=e.length>1,r=e.map((e,t)=>`
                <tr${t%2==1?` class="alt"`:``}>
                    <td>${D(e.kode_spk)}</td>
