    ...
    <div class="receipt">
        ...
        <table class="topline">
            <tr>
                ...
                <td class="qty"></td>
                <td class="amount" style="font-weight: bold;">${r()}</td>
            </tr>
        </table>
