import{r as e}from"./chunk-CilyBKbf.js";import{a as t,i as n,l as r,n as i}from"./app-rTYS588G.js";import{t as a}from"./AdminLayout-DQrSFTU3.js";var o=e(r(),1),s=i();function c({produksi:e,tglAwal:r,tglAkhir:i}){let[c,l]=o.useState(``),[u,d]=o.useState(r||``),[f,p]=o.useState(i||``),[m,h]=o.useState([]),g=(0,o.useRef)(null),_=(0,o.useRef)(null),v=e.data.map(e=>e.id),y=v.length>0&&m.length===v.length,b=e=>{h(t=>t.includes(e)?t.filter(t=>t!==e):[...t,e])},x=()=>{h(y?[]:[...v])},S=e.data.filter(e=>m.includes(e.id)),C=S.reduce((e,t)=>e+Number(t.total_harga||0),0),w=S.reduce((e,t)=>e+Number(t.qty||0),0),T=e=>{e.preventDefault(),h([]),t.get(`/produksi/data-saya`,{search:c,tgl_awal:u,tgl_akhir:f},{preserveState:!0,replace:!0})},E=e=>{if(e&&S.length>0){let e=A(S),t=_.current?.contentDocument||_.current?.contentWindow?.document;t&&(t.open(),t.write(e),t.close()),g.current?.showModal()}},D=e=>String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`),O=(e=new Date)=>new Intl.DateTimeFormat(`id-ID`,{day:`2-digit`,month:`short`,year:`numeric`}).format(e),k=(e=new Date)=>new Intl.DateTimeFormat(`id-ID`,{hour:`2-digit`,minute:`2-digit`,hour12:!1}).format(e),A=e=>{let t=new Date,n=e.length>1,r=e.map((e,t)=>`
                <tr${t%2==1?` class="alt"`:``}>
                    <td>${D(e.kode_spk)}</td>
                    <td>${D(e.customer?.nama)}</td>
                    <td>${D(e.bahan?.bahan)}</td>
                    <td class="num">${D(e.qty)}</td>
                    <td class="num">${D(e.tinggi)}x${D(e.lebar)} ${D(e.satuan)}</td>
            ...
            <html>
                <head>
                    <title>Struk Produksi - ${n?e.length+` item`:D(e[0].kode_spk)}</title>
                    <style>
                    ...
                    <div class="receipt">
                        ...
                        `:`
                            <div class="info-row">
                                ...
                                <span>${D(e[0].kode_spk)}</span>
                            </div>
                            <div class="info-row">
                                <span class="label">Customer</span>
                                <span>${D(e[0].customer?.nama)}</span>
                            </div>
                            <div class="info-row">
                                <span class="label">Bahan</span>
                                <span>${D(e[0].bahan?.bahan)}</span>
                            </div>
                        `}
                            ...
                            ${n?`
                                <tfoot>
                                    <tr class="total-row">
                                        ...
                                        <td class="num">${w}</td>
                                        <td></td>
                                        <td class="num">Rp ${C.toLocaleString(`id-ID`)}</td>
                                    </tr>
                                </tfoot>
                            `:``}
                        </table>
