...
export const buildProductionReceiptHtml = ({ items, auth, paymentType, diskonInfo, minimumHarga = 0, hargaAkhirInvoice = null, uang = null, kembalian = null }) => {
    ...
    const itemRows = items.map((item, i) => `
            <tr${i % 2 === 1 ? ' class="alt"' : ''}>
                ...
                <td class="amount" style="font-size: 12px; font-weight: bold;">${formatMoney(item.total_harga)}</td>
            </tr>
...
<body>
    <div class="receipt">
        ...
        <table class="topline">
            <tr>
                <td class="bahan invoice" style="font-weight: bold; font-size: 13px">${invoiceNumber}</td>
                <td class="ukuran-col"></td>
                <td class="qty"></td>
                <td class="amount" style="font-weight: bold; font-size: 13px">${formatReceiptDateShort(printedAt)}</td>
            </tr>
        </table>
