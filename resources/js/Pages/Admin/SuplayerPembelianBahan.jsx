...
export default function SuplayerPembelianBahan({
    suplayer,
    kode,
    title = 'Data Suplayer Pembelian Bahan',
    baseUrl = '/suplayer-pembelian-bahan',
    exportTitle = 'Data Suplayer Pembelian Bahan',
    exportFileName = 'data_suplayer_pembelian_bahan.pdf',
}) {
    const [search, setSearch] = useState('');

    useEffect(() => {
        const t = setTimeout(() => {
            router.get('/suplayer-pembelian-bahan', { search }, { preserveState: true, replace: true });
        }, 500);
