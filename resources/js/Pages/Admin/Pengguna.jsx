                                    ...
                                    <div className="modal-box">
                                        ...
                                        <form onSubmit={save} >
                                            ...
                                            <label className="form-control w-full mt-2">
                                                ...
                                                <select name="" className='input input-bordered iput-success' id="" required onChange={(e) => setData('role', e.target.value)}>
                                    ...
                                    <div className="modal-box">
                                        ...
                                        <form onSubmit={update} >
                                            ...
                                            <label className="form-control w-full mt-2">
                                                ...
                                                <select name="" className='input input-bordered iput-success' id="" required>
